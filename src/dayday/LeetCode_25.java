...
//        int i = num.LeetCode25Impl.maxArea(new int[]{0,14,6,2,10,9,4,1,10,3});
    ...
    public static void num11() {
        int r = LeetCode25Impl.romanToIn("III");
        System.out.println("result = " + r);
    }

    public static void num12() {
        String s = LeetCode25Impl.longestCommonPrefixNew(new String[]{"a"});
        String s1 = LeetCode25Impl.longestCommonPrefixNew(new String[]{""});
        String s2 = LeetCode25Impl.longestCommonPrefixNew(new String[]{"flower", "flow", "flight"});
        System.out.println("result = " + s);
        System.out.println("result = " + s1);
        System.out.println("result = " + s2);
    }
    ...
    public static void num13() {
        List<List<Integer>> lists = LeetCode25Impl.threeNum(new int[]{-1, 0, 1, 2, -1, -4});
        List<List<Integer>> lists1 = LeetCode25Impl.threeNum(new int[]{});
        List<List<Integer>> lists2 = LeetCode25Impl.threeNum(new int[]{0});
    ...
    public static void num14() {
        List<String> strings = LeetCode25Impl.letterCombinations("123");
        System.out.println(Arrays.toString(strings.toArray()));
    }

    public static void num15() {
        boolean valid = LeetCode25Impl.isValid("()");
        boolean valid1 = LeetCode25Impl.isValid("()[]{}");
        boolean valid2 = LeetCode25Impl.isValid("()[){]");
        System.out.println(" result = " + valid);
        System.out.println(" result = " + valid1);
        System.out.println(" result = " + valid2);
    }

    public static void num16() {
        LeetCode25Impl.ListNode l1 = new LeetCode25Impl.ListNode(1);
        LeetCode25Impl.ListNode l11 = new LeetCode25Impl.ListNode(2);
        l1.next = l11;
        LeetCode25Impl.ListNode l12 = new LeetCode25Impl.ListNode(4);
        l11.next = l12;

        LeetCode25Impl.ListNode l2 = new LeetCode25Impl.ListNode(1);
        LeetCode25Impl.ListNode l21 = new LeetCode25Impl.ListNode(3);
        l2.next = l21;
        LeetCode25Impl.ListNode l22 = new LeetCode25Impl.ListNode(4);
        l21.next = l22;

        LeetCode25Impl.mergeTwoLists(l1, l2);
    }

    public static void num17() {
        List<String> strings = LeetCode25Impl.generateParenthesis(3);
        System.out.println("result=" + Arrays.toString(strings.toArray()));
    }

    public static void num18() {
        LeetCode25Impl.ListNode l1 = new LeetCode25Impl.ListNode(1);
        LeetCode25Impl.ListNode l11 = new LeetCode25Impl.ListNode(4);
        l1.next = l11;
        LeetCode25Impl.ListNode l12 = new LeetCode25Impl.ListNode(5);
        l11.next = l12;
        ...
        LeetCode25Impl.ListNode l3 = new LeetCode25Impl.ListNode(2);
        LeetCode25Impl.ListNode l31 = new LeetCode25Impl.ListNode(6);
        l3.next = l31;

        LeetCode25Impl.ListNode[] data = new LeetCode25Impl.ListNode[]{
                l1, l2, l3
        };
        LeetCode25Impl.ListNode listNode = LeetCode25Impl.mergeKLists(data);
    ...
    public static void num19() {
        LeetCode25Impl.ListNode l1 = new LeetCode25Impl.ListNode(1);
        LeetCode25Impl.ListNode l2 = new LeetCode25Impl.ListNode(4);
        l1.next = l2;
        LeetCode25Impl.ListNode l3 = new LeetCode25Impl.ListNode(5);
        l2.next = l3;

        LeetCode25Impl.ListNode l4 = new LeetCode25Impl.ListNode(6);
        l3.next = l4;
        LeetCode25Impl.ListNode l5 = new LeetCode25Impl.ListNode(7);
        l4.next = l5;


        LeetCode25Impl.ListNode listNode = LeetCode25Impl.swapPairs(l1);
        System.out.println("result = " + listNode);
    }

    public static void num20() {
        LeetCode25Impl.ListNode l1 = new LeetCode25Impl.ListNode(1);
        LeetCode25Impl.ListNode l2 = new LeetCode25Impl.ListNode(2);
        l1.next = l2;
//        num.LeetCode25Impl.num.ListNode l3 = new num.LeetCode25Impl.num.ListNode(3);
//        l2.next = l3;
//
//        num.LeetCode25Impl.num.ListNode l4 = new num.LeetCode25Impl.num.ListNode(4);
//        l3.next = l4;
//        num.LeetCode25Impl.num.ListNode l5 = new num.LeetCode25Impl.num.ListNode(5);
//        l4.next = l5;

        LeetCode25Impl.ListNode listNode = LeetCode25Impl.reverseKGroup(l1, 2);
        System.out.println(" result=" + listNode);
    }

    public static void num21() {
        int i = LeetCode25Impl.removeDuplicates(new int[]{1, 1, 2});
        int i1 = LeetCode25Impl.removeDuplicates(new int[]{0, 0, 1, 1, 2, 2, 3, 3, 4});
        int i2 = LeetCode25Impl.removeDuplicates(new int[]{});
...
//        int i = num.LeetCode25Impl.strStr("hello", "ll");
//        int i1 = num.LeetCode25Impl.strStr("aaaaaa", "bba");
        int i2 = LeetCode25Impl.strStrNew("mississippi", "pi");//"mississippi"
//        System.out.println("result = " + i);
//        System.out.println("result = " + i1);
        System.out.println("result = " + i2);
    }
    ...
    public static void num23() {
        List<Integer> abcd = LeetCode25Impl.findSubstring("barfoofoobarthefoobarman", new String[]{"bar", "foo", "the"});

    }

    public static void num24() {
        int[] re = new int[]{2, 3, 1};
        LeetCode25Impl.nexPermutation(re);
        System.out.println("result = " + Arrays.toString(re));
    }

    public static void num25() {
        int i = LeetCode25Impl.longestValidParentheses("()(()");
        System.out.println("result = " + i);
    }
}

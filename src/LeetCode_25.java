...
//        int i = LeetCode25Impl.maxArea(new int[]{1, 8,6,2,5,4,8,3,7});
//        int i = LeetCode25Impl.maxArea(new int[]{4,3,2,1,4});
//        int i = LeetCode25Impl.maxArea(new int[]{0,14,6,2,10,9,4,1,10,3});
    ...
    public static void num20() {
        ...
        l1.next = l2;
//        LeetCode25Impl.ListNode l3 = new LeetCode25Impl.ListNode(3);
//        l2.next = l3;
//
//        LeetCode25Impl.ListNode l4 = new LeetCode25Impl.ListNode(4);
//        l3.next = l4;
//        LeetCode25Impl.ListNode l5 = new LeetCode25Impl.ListNode(5);
//        l4.next = l5;
...
//        int i = LeetCode25Impl.strStr("hello", "ll");
//        int i1 = LeetCode25Impl.strStr("aaaaaa", "bba");
